...
export const selectHasAppDrawerOpen = createSelector(selectAppDrawerOpen, (openDrawer) => Boolean(openDrawer));

export const selectIsDrawerOpenForType = createSelector(
  (state, type) => type,
  selectAppDrawerOpen,
  (type, openDrawer) => Boolean(openDrawer === type)
);
